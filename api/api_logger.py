'''Modulo python che contiene funzioni di interazione con il DB per la gestione 
di Logs e statistiche, ergo funzioni di pseudonimizzazione, anonimizzazione,
inserimento log e statistiche, richiesta dati al DB gestionale. Contiene anche 
funzionalità di esempio per l'inserimento di dati di log casuali nel DB.'''
...
def anonimizzatore(dati: list) -> list:
    """k-anonimity"""
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print(f"SmartCardID Generato: {smartID}, SmartCardID pseudonimizzato: {pseudoSmartID}, ID Palestra: {palestraID}, Timestamp: {timestamp}")
